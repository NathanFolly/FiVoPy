...
# The boundary conditions. We change the original cavity BC to repredsent flow through a pipe
...
#yVelocity.faceGrad.constrain(0.,mesh.facesRight)

X,Y = mesh.faceCenters
#pressureCorrection.constrain(0., mesh.facesTop & (X < dX) | mesh.facesBottom & (X<LX-dX))

#the viewers:

if __name__=='__main__':
    viewer = Viewer(vars=(pressure,xVelocity,yVelocity,velocity),xmin=0., xmax=4., ymin=0., ymax=1., colorbar=True)
